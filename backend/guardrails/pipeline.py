"""
NeMo Guardrails pipeline for Northline.
...
_executor = ThreadPoolExecutor(max_workers=2, thread_name_prefix="northline-guardrails")
...
def guardrails_enabled() -> bool:
    from guardrails.flags import guardrails_enabled as _enabled
...
async def _run_self_check_input(message: str) -> tuple[bool, str]:
    ...
    if verdict.startswith("yes"):
        return True, (
            "I can't help with that request. I'm Northline — ask me about planning a safe, "
